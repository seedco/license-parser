...
Pod::Spec.new do |s|
  s.name             = "Seed-LicenseParser"
  s.version          = "0.5.9-seed.0"
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = "https://github.com/seedco/license-parser"
  s.license          = 'MIT'
  s.author           = { "Clayton LZ" => "clayton@hauz.io" }
  s.source           = { :git => "https://github.com/seedco/license-parser.git", :tag => s.version.to_s }
