...
| Expiration Date        | Document Expiration Date                                                                                                                             | Date | `expirationDate`          |
| Issue Date             | Document Issue Date                                                                                                                                  | Date | `issueDate`               |
| Date of Birth          | Customer Date of Birth                                                                                                                               | Date | `dateOfBirth`             |
